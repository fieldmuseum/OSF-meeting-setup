...
# SPNHCabs <- read_csv("SPNHC 2019 Chicago Abstract Submission Form (Responses) - Form Responses 1_20190303.csv")
...
# remove KEW as bibliographic contributor
for (i in 1:10) {  # NROW(SPNHCabs)) {
